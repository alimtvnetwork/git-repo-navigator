...
<package xmlns="http://schemas.chocolatey.org/2012/06/nuspec">
  <metadata>
    ...
    <projectUrl>https://github.com/alimtvnetwork/git-repo-navigator</projectUrl>
    <licenseUrl>https://github.com/alimtvnetwork/git-repo-navigator/blob/main/LICENSE</licenseUrl>
    ...
    <projectSourceUrl>https://github.com/alimtvnetwork/git-repo-navigator</projectSourceUrl>
    <packageSourceUrl>https://github.com/alimtvnetwork/git-repo-navigator</packageSourceUrl>
    <releaseNotes>https://github.com/alimtvnetwork/git-repo-navigator/releases</releaseNotes>
  </metadata>
  <files>
...
$packageArgs = @{
  packageName    = 'gitmap'
  url64bit       = 'https://github.com/alimtvnetwork/git-repo-navigator/releases/download/v2.49.1/gitmap-v2.49.1-windows-amd64.zip'
