  ...
  return (
    <DocsLayout>
      <div className="space-y-8">
        ...
        {/* Command & Alias */}
        <section>
          <h2 className="text-xl font-mono font-semibold mb-3">Command</h2>
        ...
        {/* Features */}
        <section>
          <h2 className="text-xl font-mono font-semibold mb-4">Features</h2>
        ...
        {/* Version Resolution */}
        <section>
          <h2 className="text-xl font-mono font-semibold mb-3">Version Resolution</h2>
        ...
        {/* Behaviour */}
        <section>
          <h2 className="text-xl font-mono font-semibold mb-3">Behaviour</h2>
...
# [dry-run] Would remove .gitmap/release/v2.20.0.json`} title="Dry-run preview" />
        ...
        {/* Edge Cases */}
        <section>
          <h2 className="text-xl font-mono font-semibold mb-3">Edge Cases</h2>
          <div className="rounded-lg border border-border overflow-hidden">
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-muted/50">
        ...
        {/* Exit Codes */}
        <section>
          <h2 className="text-xl font-mono font-semibold mb-3">Exit Codes</h2>
          <div className="rounded-lg border border-border overflow-hidden">
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-muted/50">
        ...
        {/* Output Constants */}
        <section>
          <h2 className="text-xl font-mono font-semibold mb-3">Output Constants</h2>
          <div className="rounded-lg border border-border overflow-hidden">
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-muted/50">
        ...
        {/* Implementation */}
        <section>
          <h2 className="text-xl font-mono font-semibold mb-3">Implementation</h2>
          <div className="rounded-lg border border-border overflow-hidden">
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-muted/50">
